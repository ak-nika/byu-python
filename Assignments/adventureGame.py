...
if adventure.lower() == "fantasy":
    ...
    print(
        "You are a knight on a quest to rescue the princess from a dragon. You are at the entrance of a dark cave."
    )
    ...
    if choice.lower() == "enter":
        ...
        choice1 = input(
            "Do you DRAW your sword to attack, use MAGIC to hide yourself, or SNEAK around quietly? "
        )
        ...
        if choice1.lower() == "draw":
            ...
            choice2 = input(
                "Do you FREE the princess first, STEAL the dragon's treasure, or ENCHANT the dragon's magic? "
            ).strip()
            ...
            choice2 = input(
                "Do you CONTINUE sneaking, CLIMB the tree, or turn BACK? "
            ).strip()
        ...
        choice1 = input(
            "Do you ENTER the passage, GO BACK or CONTINUE searching? "
        ).strip()
    ...
    print(
        "You have crash landed on an alien unknown alien planet. You need to find resources to repair your ship."
    )
    choice1 = input(
        "Do you EXPLORE the planet, SEARCH for resources, or WAIT? "
    ).strip()
    ...
    if choice1.lower() == "explore":
        ...
        choice2 = input(
            "Do you OBSERVE them, FLEE back to your ship, or ATTACK them? "
        ).strip()

        if choice2.lower() == "observe":
            print("\nYou observed the creatures.")
            choice3 = input(
                "Do you MIMIC them, FLEE back to your ship, or WAIT? "
            ).strip()
            ...
            if choice3.lower() == "wait":
                ...
                print(
                    "You find the resources to repair your ship and repair your ship."
                )
        ...
        choice2 = input(
            "Do you ENTER the civilization, RETURN to your ship, or CONTINUE searching? "
        ).strip()
        ...
        if choice2.lower() == "enter":
            ...
            choice3 = input(
                "Do you TAKE the technology, LEAVE it and return to your ship, or CONTINUE searching? "
            ).strip()
        ...
        pass_code = int(
            input(
                "Enter the pass code (hint: The pass code is a 4 digit number): "
            ).strip()
        )
    ...
    print(
        "You are a detective asked to investigate a mysterious mansion that is said to be haunted."
    )
    ...
    if choice.lower() == "enter":
        ...
        choice1 = input(
            "Do you investigate the ATTIC, BASEMENT, or LIVING ROOM? "
        ).strip()
        ...
        if choice1.lower() == "attic":
            ...
            choice2 = input(
                "Do you INVESTIGATE the symbols, STAND in the circle, or LEAVE? "
            ).strip()
            ...
            if choice2.lower() == "call":
                ...
                if sanity < 50:
                    ...
                    print(
                        "You can't take it anymore and run out of the mansion but something follows..."
                    )
                else:
                    print(
            ...
            if choice2.lower() == "investigate":
                ...
                if sanity < 50:
                    ...
                    print(
                        "You eventually go insane and run out of the mansion a mad man."
                    )
                else:
        ...
        choice1 = input(
            "Do you ENTER the graveyard, RETURN to the entrance, or LEAVE the mansion? "
        )

        if choice1.lower() == "enter":
            print("\nYou enter the graveyard and notice a thick fog")
            choice2 = input(
                "Do you ENTER the fog, TURN back to the entrance, or LEAVE? "
            ).strip()

            if choice2.lower() == "enter":
                print("\nYou entered the fog.")
                print(
                    "You found some ancient text. This text solves the mystery of the mansion."
                )
                print("YOU WIN!!")
            elif choice2.lower() == "turn":
                print("\nYou turned back to the entrance.")
                print(
                    "You hear a strange noise. The mansion has claimed another victim. You lose."
                )
            elif choice2.lower() == "leave":
                print("COWARD.")
                print(
                    "You try to leave but are attacked by ghosts and die like a coward :)"
                )
            else:
